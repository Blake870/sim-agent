...
Copyright 2026 Andrew Banasevich
...
the Apache License, Version 2.0 that is effective on the second anniversary of the
date we make the Software available. On or after that date, you may use the
Software under the Apache License, Version 2.0, in which case the following will
apply:

We hereby grant you the rights described in the Apache License, Version 2.0, and
you may use the Software under the terms of that license, a copy of which is
